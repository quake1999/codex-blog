...
export function HomeClient({ posts }: { posts: PostSummary[] }) {
  ...
  return <main>
    ...
    <div className="home-tools shell">
      <a className="project-spotlight" href="https://daylist-todo.garden-bream-0513.chatgpt.site" target="_blank" rel="noreferrer"><div><span>LIVE PROJECT / 01</span><h2>FORMA 健身打卡</h2><p>记录每一次训练，让持续发生。</p></div><strong>打开应用 ↗</strong></a>
      <Link className="project-spotlight template-spotlight" href="/new-post"><div><span>WRITING TOOL / 02</span><h2>新建文章模板</h2><p>复制统一格式，在 GitHub 创建下一篇文章。</p></div><strong>使用模板 →</strong></Link>
    </div>
